...
public class Q03 {
    ...
    public void test() {
        ...
        //0r ==> WebElement form = driver.findElement(By.xpath("//a[@href='/Students/Form']"));
        //0r ==> driver.findElement(By.linkText("Form")).click();
        ...
        //or==> driver.findElement(By.xpath"(//input[@type='radio'])[1]")).click();
        //or==> driver.findElement(By.xpath"(//input[@name='optradio'])[1]")).click();
