  ...
  Then
    ...
    */
    ...
    public void test(){
        ...
        System.out.println("Number of delete buttons before delete: "+deleteButtons.size());//100
...
//        //Assert that 20 buttons were deleted.
        ...
        System.out.println("Number of delete buttons after delete: "+deleteButtonsAfterDelete.size());//80
